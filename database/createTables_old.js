      ...
      if (!columns) {
        ...
        if (hasId && !hasLeadId) {
          ...
          if (hasPreviousStatus) {
            await runQueryOn(conn, "ALTER TABLE crm_tbl_leads DROP COLUMN previous_lead_status", "Dropped previous_lead_status column", "Error dropping previous_lead_status column:");
          }
